    ...
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <button
          ...
          className="fixed bottom-5 right-5 z-50 opacity-20 hover:opacity-100 focus:opacity-100 transition-all duration-300 bg-primary text-primary-foreground px-3 py-2 text-[10px] font-mono uppercase tracking-widest border border-primary-foreground/20 hover:border-accent flex items-center gap-1.5 shadow-lg"
